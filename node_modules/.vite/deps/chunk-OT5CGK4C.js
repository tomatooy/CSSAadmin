...
var Nav2 = React6.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react4.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react4.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime5.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
//# sourceMappingURL=chunk-OT5CGK4C.js.map
