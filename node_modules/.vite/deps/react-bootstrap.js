import {
  Alert_default,
  CloseButton_default
} from "./chunk-IJACJGJY.js";
import {
  CardImg_default,
  Card_default
} from "./chunk-UWYPOH7Z.js";
import {
  divWithClassName_default
} from "./chunk-2Z26I5YO.js";
import {
  TabContainer_default,
  Tab_default
} from "./chunk-TCWOHJG3.js";
import {
  Col_default,
  ...
  require_warning,
  useCol
} from "./chunk-JFEAAUQJ.js";
import {
  Table_default
} from "./chunk-B3YK6LOF.js";
import {
  NavContext_default,
  NavItem_default,
  NavLink_default,
...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-LZ6K2BQG.js";
import "./chunk-SY6MNXBF.js";
import {
...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-RPWQ6HCO.js";
import {
  forEach,
  map
} from "./chunk-NKYSXRV3.js";
import {
  createWithBsPrefix
} from "./chunk-4FJBAKAD.js";
import {
  Image_default,
  propTypes
} from "./chunk-DD4C4LXB.js";
import {
  require_prop_types
} from "./chunk-Q4O2WPEZ.js";
import {
  Button_default as Button_default2
} from "./chunk-IJMDKTYD.js";
import {
  Button_default
} from "./chunk-4HAEB54I.js";
import {
  DEFAULT_BREAKPOINTS,
...
var CarouselItem = React15.forwardRef(({
  ...
  const finalClassName = (0, import_classnames13.default)(className, useBootstrapPrefix(bsPrefix, "carousel-item"));
...
var Carousel = React16.forwardRef(({
  ...
  const {
    ...
    onTouchMove,
    onTouchEnd,
    prevIcon = (0, import_jsx_runtime14.jsx)("span", {
      "aria-hidden": "true",
      className: "carousel-control-prev-icon"
    }),
    prevLabel = "Previous",
    nextIcon = (0, import_jsx_runtime14.jsx)("span", {
      "aria-hidden": "true",
  ...
  const nextDirectionRef = (0, import_react11.useRef)(null);
  const [direction, setDirection] = (0, import_react11.useState)("next");
  const [paused, setPaused] = (0, import_react11.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react11.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react11.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react11.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react11.useRef)();
  ...
  const handleEnter = (0, import_react11.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null ? void 0 : onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react11.useCallback)(() => {
    setIsSliding(false);
    onSlid == null ? void 0 : onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react11.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null ? void 0 : onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react11.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null ? void 0 : onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react11.useRef)(0);
  const touchDeltaXRef = (0, import_react11.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react11.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react11.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react11.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react11.useRef)();
  (0, import_react11.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react11.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
    onSelect == null ? void 0 : onSelect(index, event);
  }), [indicators, numChildren, onSelect]);
  return (0, import_jsx_runtime15.jsxs)(Component2, {
    ref: elementRef,
    ...props,
    ...
    className: (0, import_classnames14.default)(className, prefix, slide && "slide", fade && `${prefix}-fade`, variant && `${prefix}-${variant}`),
    children: [indicators && (0, import_jsx_runtime14.jsx)("div", {
      className: `${prefix}-indicators`,
      children: map(children, (_, index) => (0, import_jsx_runtime14.jsx)("button", {
        type: "button",
        "data-bs-target": "",
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime14.jsx)(TransitionWrapper_default, {
          in: isActive,
          onEnter: isActive ? handleEnter : void 0,
          onEntered: isActive ? handleEntered : void 0,
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React16.cloneElement(child, {
            ...innerProps,
            className: (0, import_classnames14.default)(child.props.className, isActive && status !== "entered" && orderClassName, (status === "entered" || status === "exiting") && "active", (status === "entering" || status === "exiting") && directionalClassName)
          })
        }) : React16.cloneElement(child, {
          className: (0, import_classnames14.default)(child.props.className, isActive && "active")
        });
      })
    }), controls && (0, import_jsx_runtime15.jsxs)(import_jsx_runtime16.Fragment, {
      children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime15.jsxs)(Anchor_default, {
        className: `${prefix}-control-prev`,
        onClick: prev,
        children: [prevIcon, prevLabel && (0, import_jsx_runtime14.jsx)("span", {
          className: "visually-hidden",
          children: prevLabel
        })]
      }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime15.jsxs)(Anchor_default, {
        className: `${prefix}-control-next`,
        onClick: next,
        children: [nextIcon, nextLabel && (0, import_jsx_runtime14.jsx)("span", {
          className: "visually-hidden",
          children: nextLabel
        })]
      })]
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react13.useRef)(modifiers);
  const popperInstanceRef = (0, import_react13.useRef)();
  const update = (0, import_react13.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react13.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react13.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react13.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react13.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react14.useRef)(false);
  const waitingForTrigger = (0, import_react14.useRef)(false);
  const handleMouseCapture = (0, import_react14.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react15.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react15.useRef)(false);
  const {
    flip: flip2,
    offset: offset2,
    rootCloseEvent,
...
function DropdownMenu(_ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(import_jsx_runtime17.Fragment, {
...
function DropdownToggle({
  ...
  return (0, import_jsx_runtime20.jsx)(import_jsx_runtime19.Fragment, {
    children: children(props, meta)
  });
}
...
var DropdownItem = React20.forwardRef((_ref, ref) => {
  let {
    eventKey,
    disabled,
    onClick,
  ...
  return (0, import_jsx_runtime21.jsx)(Component2, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
var Context = (0, import_react18.createContext)(canUseDOM_default ? window : void 0);
...
function Dropdown({
  ...
  return (0, import_jsx_runtime22.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime22.jsx)(DropdownContext_default.Provider, {
      value: context4,
      children
    })
  });
...
var DropdownContext2 = React22.createContext({});
...
var DropdownItem2 = React23.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
  ...
  return (0, import_jsx_runtime23.jsx)(Component2, {
    ...
    ...dropdownItemProps,
    ref,
    className: (0, import_classnames15.default)(className, prefix, meta.isActive && "active", disabled && "disabled")
  });
});
...
var context3 = React24.createContext(null);
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react20.useCallback)((refValue) => {
...
var DropdownMenu2 = React25.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react21.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react21.useContext)(DropdownContext_default2);
  ...
  return (0, import_jsx_runtime24.jsx)(Component2, {
    ...
    className: (0, import_classnames16.default)(className, prefix, show && "show", alignEnd && `${prefix}-end`, variant && `${prefix}-${variant}`, ...alignClasses)
  });
});
...
var DropdownToggle2 = React26.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
  ...
  const dropdownContext = (0, import_react22.useContext)(DropdownContext_default);
  ...
  return (0, import_jsx_runtime25.jsx)(Component2, {
    className: (0, import_classnames17.default)(className, prefix, split && `${prefix}-split`, (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
...
var Dropdown2 = React27.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
  ...
  const isInputGroup = (0, import_react23.useContext)(InputGroupContext_default);
  ...
  return (0, import_jsx_runtime26.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime26.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime26.jsx)(Component2, {
        ...props,
        ref,
        className: (0, import_classnames18.default)(className, show && "show", directionClasses[drop])
      })
    })
  });
});
...
var DropdownButton = React28.forwardRef(({
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime28.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime27.jsx)(DropdownToggle_default2, {
    id,
    href,
    size: size2,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime27.jsx)(DropdownMenu_default2, {
    role: menuRole,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime31.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime31.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime31.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime31.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React31.forwardRef(({
  ...
  return (0, import_jsx_runtime31.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime31.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames21.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, hasValidation && "has-validation")
    })
  });
});
...
var ListGroupItem = React32.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React33.forwardRef((props, ref) => {
  const {
    className,
  ...
  return (0, import_jsx_runtime33.jsx)(Nav_default, {
    ref,
    ...controlledProps,
    as,
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = (0, import_react25.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function useTransition({
  ...
  const isInitialRef = (0, import_react26.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react26.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  return exited && !inProp ? null : (0, import_react26.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime34.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
    return (0, import_jsx_runtime34.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime34.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react27.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react27.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react27.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react27.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime35.jsx)("div", Object.assign({}, props)),
    ...
    onEntering,
    onEntered
  } = _ref, rest = _objectWithoutPropertiesLoose4(_ref, _excluded4);
  const container = useWaitForDOMRef(containerRef);
  const modal = useModalManager(providedManager);
  const isMounted = useMounted();
  const prevShow = usePrevious(show);
  const [exited, setExited] = (0, import_react27.useState)(!show);
  const lastFocusRef = (0, import_react27.useRef)(null);
  (0, import_react27.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react27.useRef)();
  const removeKeydownListenerRef = (0, import_react27.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime35.jsx)("div", Object.assign({}, dialogProps, {
    children: React35.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime35.jsx)(import_jsx_runtime36.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime37.jsxs)(import_jsx_runtime36.Fragment, {
...
var ModalContext = React36.createContext({
...
var ModalDialog = React37.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var AbstractModalHeader = React38.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context4 = (0, import_react28.useContext)(ModalContext_default);
  ...
  return (0, import_jsx_runtime40.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime39.jsx)(CloseButton_default, {
...
var ModalHeader = React39.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
  ...
  return (0, import_jsx_runtime41.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime42.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal2 = React40.forwardRef(({
  ...
  const renderBackdrop = (0, import_react29.useCallback)((backdropProps) => (0, import_jsx_runtime42.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames26.default)(`${bsPrefix}-backdrop`, backdropClassName, !animation && "show")
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime42.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    style: baseModalStyle,
    className: (0, import_classnames26.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
    onClick: backdrop ? handleClick : void 0,
    onMouseUp: handleMouseUp,
    "aria-label": ariaLabel,
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime42.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime42.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime42.jsx)(Modal_default, {
      show,
      ref: mergedRef,
      backdrop,
      container,
...
var NavbarCollapse = React42.forwardRef(({
  ...
  const context4 = (0, import_react30.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime44.jsx)(Collapse_default, {
...
var NavbarToggle = React43.forwardRef(({
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react31.useContext)(NavbarContext_default) || {};
  ...
  return (0, import_jsx_runtime45.jsx)(Component2, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames28.default)(className, bsPrefix, !expanded && "collapsed"),
    children: children || (0, import_jsx_runtime45.jsx)("span", {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react33.useMemo)(function() {
...
var OffcanvasToggling = React44.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime46.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React44.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React45.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
  ...
  return (0, import_jsx_runtime47.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime48.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React46.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const modalManager = (0, import_react34.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react34.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react34.useState)(false);
  ...
  const renderBackdrop = (0, import_react34.useCallback)((backdropProps) => (0, import_jsx_runtime48.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames31.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime48.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames31.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime50.jsxs)(import_jsx_runtime49.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime48.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React47.forwardRef((props, ref) => {
  const context4 = (0, import_react35.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime51.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React48.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  const handleCollapse = (0, import_react36.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react36.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime52.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime52.jsx)(SelectableContext_default.Provider, {
      value: handleCollapse,
      children: (0, import_jsx_runtime52.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames32.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
var NavDropdown = React49.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime54.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames33.default)(className, navItemPrefix),
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React50.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
  ...
  const [exited, setExited] = (0, import_react38.useState)(!props.show);
...
var Popover = React52.forwardRef(({
  ...
  return (0, import_jsx_runtime56.jsxs)("div", {
    ...
    className: (0, import_classnames34.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react39.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
var Overlay2 = React53.forwardRef(({
  ...
  const popperRef = (0, import_react40.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react40.useState)(null);
  ...
  return (0, import_jsx_runtime57.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React53.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames35.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react41.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react41.useRef)("");
  ...
  const handleShow = (0, import_react41.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react41.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react41.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react41.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react41.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react41.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react41.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime60.jsxs)(import_jsx_runtime59.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react41.cloneElement)(children, triggerProps), (0, import_jsx_runtime58.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React55.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime61.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames36.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime62.jsxs)(Component2, {
      className: "page-link",
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime61.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React55.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime62.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React56.forwardRef(({
  ...
  return (0, import_jsx_runtime63.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames37.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames38.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React57.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime64.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React58.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime66.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames39.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime66.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React59.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
  ...
  return (0, import_jsx_runtime66.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react42.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Ratio = React60.forwardRef(({
  ...
  return (0, import_jsx_runtime67.jsx)("div", {
    ...
    className: (0, import_classnames40.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React60.Children.only(children)
  });
});
...
var Spinner = React62.forwardRef(({
  ...
  return (0, import_jsx_runtime69.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames42.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React63.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime71.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime70.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime70.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
...
var Stack = React64.forwardRef(({
  ...
  return (0, import_jsx_runtime72.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames43.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
var ToastFade = React65.forwardRef((props, ref) => (0, import_jsx_runtime73.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React66.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React67.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  return (0, import_jsx_runtime75.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames44.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime74.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var Toast = React68.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime76.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames45.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime76.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime76.jsx)(Transition, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToastContainer = React69.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime77.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames46.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop5 = () => void 0;
var ToggleButton = React70.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime80.jsxs)(import_jsx_runtime79.Fragment, {
    children: [(0, import_jsx_runtime78.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime78.jsx)(Button_default2, {
      ...props,
      ref,
      className: (0, import_classnames47.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React71.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime81.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
...
var Tooltip = React72.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
  ...
  return (0, import_jsx_runtime83.jsxs)("div", {
    ref,
    style: computedStyle,
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames48.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
